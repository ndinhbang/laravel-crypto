...
class Builder extends PasetoBase
{
    ...
    /** @var Closure|null -- Do not use this. It's for unit testing! */
    protected ?Closure $unitTestEncrypter;
    ...
    public function setExpiration(?DateTimeInterface $time = null): self
    {
        ...
        return $this->set('exp', $time->format(DateTimeInterface::ATOM));
    }
     ...
     * @throws PasetoException
     */
    public function setKey(#[\SensitiveParameter] SendingKey $key, bool $checkPurpose = false): self
    {
    ...
    {
        $this->version = $version ?? new Version4();
     ...
     * @throws PasetoException
     */
    public function withKey(#[\SensitiveParameter] SendingKey $key, bool $checkPurpose = false): self
    {
